...
export default function Footer(){
    return (
        ...
        <footer>
            <div className="footer-redirect-contact">
                <div className="footer-redirect-contact-wrapper">
                <h2 className="redirect-contact-title">Let’s talk about <br /> your project</h2>
            ...
            <div className="socials">
                <div className="cenrtal-office">
                    <p className="central-office-body">
                    <span>Designo Central Office</span><br />
                    3886 Wellington Street <br /> 
                    Toronto, Ontario M9C 3J5
                    </p>
                </div>
                <div className="central-office">
                    <p className="central-office-body">
